...
#
# 2020-09-01: changed because wierd 0x0d 0x0a 0x0d treatment of downloaded gh-code:
#
# open (my $out, '>:encoding(UTF-8)'    , $os_path_abs) or print "! RN::open_url_path_abs Could not open $os_path_abs\n" ;
  open (my $out, '>:raw:encoding(UTF-8)', $os_path_abs) or print "! RN::open_url_path_abs Could not open $os_path_abs\n" ;
